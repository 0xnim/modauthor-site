...
const Dashboard =
    ({onLogout}) => {
      ...
      return (
          <div className = "dashboard-container"><div class = "container">
          <button onClick = { () => setNavbarOpen(!navbarOpen) } class =
               "open">Open
              Nav</button>
      {navbarOpen && (
        <nav class="navbar">
          ...
          <div class = "nav-icon"><img src = "/logo512.png">
          </img>
          </div><ul class = "nav-links"><li>
          <a href = "/">Dashboard</a>
            </li><li>
